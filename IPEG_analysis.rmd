...
# pd
p_direction(Bayes, parameters = "b_Condition")
# % in ROPE
rope(Bayes,ci=1, range = c(-0.10, 0.10), parameters = "b_Condition")
...
match_cond2<-posterior_gen$b_Match_conditionSMAM;match_cond3<-posterior_gen$b_Match_conditionSMAP;match_cond4<-posterior_gen$b_Match_conditionSPAM;match_cond5<-posterior_gen$b_Match_conditionSPAP
```
...
** 1) a null model M0: all conditions (including controls) are ~ equal
** 2) Unrestricted model Mu
** 3) ordered model1 M1:  Identify < S-A- = S+A- = S-A+ = S+A
** 4) ordered model2 (theory driven) M2: Identify < S-A- < S+A- = S-A+ < S+A+
...
set.seed(67);BF_M1_vs_Mu <- bayes_factor(Bayes, Bayes_gen)
BF_M1_vs_Mu
set.seed(67);BF_Mu_vs_M0 <- bayes_factor(Bayes_gen, null)
BF_Mu_vs_M0;1/BF_Mu_vs_M0$bf
set.seed(67); BF_M1_vs_M0 <- bayes_factor(Bayes, null)
BF_M1_vs_M0
...
(BF_M2_vs_Mu<-restricted_BF(m2, 4e4, 5))


# By transitivity we can obtain M1/M0, M0/M2, and M1/Mu
BF_M1_vs_Mu <- BF_M1_vs_M0$bf / BF_Mu_vs_M0$bf
BF_M0_vs_M2 <- 1/(BF_Mu_vs_M0$bf * BF_M2_vs_Mu)
BF_M1_vs_M2 <- BF_M1_vs_M0$bf * BF_M0_vs_M2

print(paste0("M1/Mu: ", BF_M1_vs_Mu))
print(paste0("M0/M2: ",BF_M0_vs_M2))
print(paste0("M1/M2: ", BF_M1_vs_M2))
print(paste0("M0/Mu: ", 1/BF_Mu_vs_M0$bf))
print(paste0("M1/M0: ", BF_M1_vs_M0$bf))
print(paste0("M2/Mu: ", BF_M2_vs_Mu))
...
test.df<-test
test.df <-test.df %>%gather("SMAM-SMAP", "SMAM-SPAM", "SMAM-SPAP", "SMAP-SPAM","SMAP-SPAP","SPAM-SPAP", key= Condition, value= Posterior)
test_plot<- violin_bayes(test.df)[[1]]
violin_bayes(test.df)[[2]]
